...
global.ghostaddons ??= {};
global.ghostaddons.events ??= {};
global.ghostaddons.events.dungeonRoom ??= {};

const listeners = global.ghostaddons.events.dungeonRoom.listeners ??= [];

let roomX = -1;
let roomZ = -1;
let notified = false;

const trigger = global.ghostaddons.events.dungeonRoom.trigger ??= register("tick", () => {
